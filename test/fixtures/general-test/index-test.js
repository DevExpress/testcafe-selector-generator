...
const { RULE_TYPE }     = SelectorGenerator;
...
test('element with several attributes', function () {
    ...
    if (browserUtils.isIE) {
        deepEqual(selectors, [
            ...
            getSelector("Selector('[alt=\"someAlt\"][name=\"someName\"]').withAttribute('data-attr', /ыть\\s+ыть \\/ /)", RULE_TYPE.byAttr),
...
test('selectors for iframe\'s elements', function () {
    ...
    deepEqual(selectors, [getSelector("Selector('html')", RULE_TYPE.byTagName)]);
    ...
    deepEqual(selectors, [getSelector("Selector('div div div img')", RULE_TYPE.byTagTree)]);
});
...
test('selector contains unescaped symbols - gh1190', function () {
    ...
    if (browserUtils.isIE) {
        deepEqual(generateSelectors(link), [
            ...
            getSelector("Selector('[data-counter^=\"[\\\\\"rc\\\\\",\\\\\"http://yandex.ru/clck/jsredir?from=yandex.r\"][data-log-node=\"uniq15199824464503338163\"][data-bem=\"{\\\\\"link\\\\\":{}}\"]')", RULE_TYPE.byAttr),
